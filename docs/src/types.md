...
This page documents all types defined in ErrorMetrics.jl, generated using [`get_type_docstring`](https://landecosystems.github.io/OmniTools.jl/dev/api/ForDocStrings/#get_type_docstring) from OmniTools.jl.
